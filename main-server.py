...
if __name__ == '__main__':
    ...
    parser.add_argument('-hd', '--heartbeat_delay', type=int, help='set heartbeat delay for secondary', default=6)
    parser.add_argument('-ht', '--heartbeat_request_timeout', type=int, help='set heartbeat delay for secondary', default=4)
